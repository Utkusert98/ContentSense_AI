          ...
          {step === 2 && !isGenerating && (
            <div className="animate-fade-in text-left">
              ...
              <div className="space-y-6">
                ...
                {/* GÜNCELLENDİ: Yazı tam olarak istediğimiz vizyoner şekle getirildi! */}
                <textarea rows={4} placeholder="Sihirli Kelimeleriniz... (Örn: Görselin hissettirdiği atmosferi anlatan, okuyanları içine çekecek samimi bir hikaye kurgula ve metnin sonunda takipçilerle etkileşim yaratacak bir soru sor)" value={promptText} onChange={(e) => setPromptText(e.target.value)} className="w-full p-4 rounded-xl border border-gray-300 bg-white/70 outline-none focus:border-[var(--color-primary)] resize-none"></textarea>
